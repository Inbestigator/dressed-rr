...
"production" !== process.env.NODE_ENV &&
    ((module.exports = function ($$$config) {
                ...
                if (isHydrating) {
                    ...
                    if (isHydrating) {
                        ...
                        (JSCompiler_temp$jscomp$0 = !nextInstance) ||
                            ((JSCompiler_temp$jscomp$0 = canHydrateSuspenseInstance(nextInstance, rootOrSingletonContext)),
                        ...
                        if (supportsHydration && prevSibling.isDehydrated) {
                            if (((prevSibling = {
                                ...
                                for (supportsHydration &&
                                    ...
                                    workInProgress.child = current; current;) {
                        ...
                        return (markRef(current, workInProgress),
                            null === current
                                ? (current = getResource(workInProgress.type, null, workInProgress.pendingProps, null))
                                    ...
                                    : isHydrating ||
                                        (workInProgress.stateNode = createHoistableInstance(workInProgress.type, workInProgress.pendingProps, requiredContext(rootInstanceStackCursor.current), workInProgress))
                            ...
                            null === current &&
                                ...
                                ((prevSibling = requiredContext(rootInstanceStackCursor.current)),
                                    ...
                                    (prevSibling = workInProgress.stateNode =
                                        resolveSingletonInstance(workInProgress.type, workInProgress.pendingProps, prevSibling, returnFiber, !1)),
                                    didSuspendOrErrorDEV ||
                                        ((returnFiber = diffHydratedPropsForDevWarnings(prevSibling, workInProgress.type, workInProgress.pendingProps, returnFiber)),
                                            null !== returnFiber &&
                                    ...
                                    (rootOrSingletonContext = !0),
                                    (nextHydratableInstance =
                                        getFirstHydratableChildWithinSingleton(workInProgress.type, prevSibling, nextHydratableInstance))),
                ...
                case 5:
                    return (null === current &&
                        ...
                        ((nextProps = getHostContext()),
                            (returnFiber = validateHydratableInstance(workInProgress.type, workInProgress.pendingProps, nextProps)),
                                ...
                                ((nextState = canHydrateInstance(prevSibling, workInProgress.type, workInProgress.pendingProps, rootOrSingletonContext)),
                                    null !== nextState
                                        ? ((workInProgress.stateNode = nextState),
                                            didSuspendOrErrorDEV ||
                                                ((nextProps = diffHydratedPropsForDevWarnings(nextState, workInProgress.type, workInProgress.pendingProps, nextProps)),
                                                    null !== nextProps &&
                                                        (buildHydrationDiffNode(workInProgress, 0).serverProps =
                                                            nextProps)),
                                            (hydrationParentFiber = workInProgress),
                ...
                for (var _node = workInProgress.child; null !== _node;) {
                    if (5 === _node.tag) {
                        ...
                        needsVisibilityToggle &&
                            isHidden &&
                            (instance = cloneHiddenInstance(instance, _node.type, _node.memoizedProps));
                        ...
                        (instance = _node.stateNode),
                            needsVisibilityToggle &&
                                isHidden &&
                                (instance = cloneHiddenTextInstance(instance, _node.memoizedProps)),
                            appendInitialChild(parent, instance);
                    }
                    else if (4 !== _node.tag) {
            ...
            if (supportsMutation) {
                ...
                if ((current = doesRequireClone(current, workInProgress)) ||
                    ...
                    _oldProps === currentInstance
                        ...
                        : (finalizeInitialChildren(_oldProps, type, newProps, currentHostContext) && markUpdate(workInProgress),
            ...
            switch (workInProgress.tag) {
                    ...
                    if (null !== current && null != workInProgress.stateNode) {
                        ...
                        popHydrationState(workInProgress)
                            ...
                            : ((nextResource = requiredContext(rootInstanceStackCursor.current)),
                                (nextResource = createInstance(renderLanes, newProps, nextResource, current, workInProgress)),
                        ...
                        if (popHydrationState(workInProgress)) {
                            ...
                            if (null !== returnFiber) {
                                switch (returnFiber.tag) {
                                    case 3:
                                        nextResource &&
                                            ((nextResource = diffHydratedTextForDevWarnings(current, renderLanes, newProps)),
                                                null !== nextResource &&
                                                    (buildHydrationDiffNode(workInProgress, 0).serverProps =
                                                        nextResource));
                                        break;
                                    ...
                                    case 5:
                                        (newProps = returnFiber.memoizedProps),
                                            nextResource &&
                                                ((nextResource = diffHydratedTextForDevWarnings(current, renderLanes, newProps)),
                                                    null !== nextResource &&
                                                        (buildHydrationDiffNode(workInProgress, 0).serverProps = nextResource));
                                }
                            }
                ...
                case 19:
                    ...
                    if (null !== nextResource.tail) {
                        return ((current = nextResource.tail),
                            ...
                            ((flags = null !== current ? current.memoizedState : null),
                                ...
                                null === current
                                    ? null === root
                                        ...
                                        : (finishedWork.stateNode = acquireResource(hoistableRoot, root, finishedWork.memoizedProps))
                                    : flags !== root
                                        ? (null === flags
                                    ...
                                    if (null === current) {
                                        ...
                                        try {
                                            (previousHoistableRoot = wasHidden.stateNode),
                                                hoistableRoot
                                                    ? runWithFiberInDEV(wasHidden, hideInstance, previousHoistableRoot)
                                    ...
                                    if (null === current) {
                                        ...
                                        try {
                                            ...
                                            hoistableRoot
                                                ...
                                                : runWithFiberInDEV(wasHidden, unhideTextInstance, instance, wasHidden.memoizedProps);
                                        }
                                        catch (error) {
                                            captureCommitPhaseError(wasHidden, wasHidden.return, error);
                                        }
                ...
                for (parentFiber = parentFiber.child; null !== parentFiber;) {
                    ...
                    22 !== fiber.tag
                        ? fiber.flags & 67108864
                            ? isStrictModeFiber &&
                                runWithFiberInDEV(fiber, doubleInvokeEffectsOnFiber, root, fiber, (fiber.mode & 64) === NoMode)
        ...
        var MAYBE_ITERATOR_SYMBOL = Symbol.iterator, REACT_CLIENT_REFERENCE = Symbol.for("react.client.reference"), isArrayImpl = Array.isArray, 
        ...
        ReactSharedInternals = (_a = React.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE) !== null && _a !== void 0 ? _a : {
            H: null,
            A: null,
            T: null,
            S: null,
...
//# sourceMappingURL=react-reconciler.development.cjs.map