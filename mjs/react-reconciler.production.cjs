...
module.exports = function ($$$config) {
    ...
    function describeNativeComponentFrame(fn, construct) {
        ...
        try {
            ...
            if (sampleStack && controlStack) {
                ...
                for (namePropDescriptor = RunInRootFrame = 0; RunInRootFrame < sampleLines.length &&
                ...
                if (RunInRootFrame === sampleLines.length ||
                    namePropDescriptor === controlLines.length) {
                    for (RunInRootFrame = sampleLines.length - 1,
        ...
        if (13 === tag) {
            ...
            nextHydratableInstance =
                supportsSingletons && 27 === tag
                    ? getNextHydratableSiblingAfterSingleton(fiber.type, nextHydratableInstance)
                    ...
                    if (!onlyLegacy) {
                        if (0 !== syncTransitionLanes) {
                            ...
                            (JSCompiler_inline_result = workInProgressRootRenderLanes),
                                (JSCompiler_inline_result = getNextLanes(root, root === workInProgressRoot ? JSCompiler_inline_result : 0, null !== root.cancelPendingCommit ||
    ...
    function throwOnInvalidObjectType(returnFiber, newChild) {
        ...
        throw Error(formatProdErrorMessage(31, "[object Object]" === returnFiber
                        ...
                        a: {
                            ...
                            newChild.type === REACT_FRAGMENT_TYPE
                                ? ((lanes = createFiberFromFragment(newChild.props.children, returnFiber.mode, lanes, newChild.key)),
                                    (lanes.return = returnFiber),
                                    (returnFiber = lanes))
                                : ((lanes = createFiberFromTypeAndProps(newChild.type, newChild.key, newChild.props, null, returnFiber.mode, lanes)),
                                    coerceRef(lanes, newChild),
                                    (lanes.return = returnFiber),
                                    (returnFiber = lanes));
                        }
    ...
    function pushOffscreenSuspenseHandler(fiber) {
        if (22 === fiber.tag) {
            if ((push(suspenseStackCursor, suspenseStackCursor.current),
        ...
        if (null === workInProgress.stateNode) {
            ...
            unresolvedOldProps || oldState !== oldContext || hasForceUpdate
                ? ("function" === typeof getDerivedStateFromProps &&
                    ...
                    (oldProps =
                        hasForceUpdate ||
                            checkShouldComponentUpdate(workInProgress, Component, oldProps, nextProps, oldState, oldContext, contextType))
                        ? (contextType$jscomp$0 ||
                            ("function" !== typeof context.UNSAFE_componentWillMount &&
                                "function" !== typeof context.componentWillMount) ||
                            ("function" === typeof context.componentWillMount &&
            ...
            contextType !== getDerivedStateFromProps ||
                ...
                ? ("function" === typeof unresolvedOldProps &&
                    ...
                    (contextType$jscomp$0 =
                        hasForceUpdate ||
                            checkShouldComponentUpdate(workInProgress, Component, contextType$jscomp$0, nextProps, oldState, newState, oldProps) ||
                            (null !== current &&
                                null !== current.dependencies &&
                                checkIfContextChanged(current.dependencies)))
                        ? (oldContext ||
            ...
            if (isHydrating) {
                ...
                if (isHydrating) {
                    ...
                    if ((JSCompiler_temp$jscomp$0 = nextInstance)) {
                        (nextInstance = canHydrateSuspenseInstance(nextInstance, rootOrSingletonContext)),
                            null !== nextInstance
                                ? ((workInProgress.memoizedState = {
                ...
                workInProgress.flags & 256
                    ...
                    : null !== workInProgress.memoizedState
                        ...
                        : (reuseSuspenseHandlerOnStack(workInProgress),
                            ...
                            (nextProps = mountWorkInProgressOffscreenFiber({ mode: "visible", children: nextProps.children }, nextInstance)),
    ...
    function beginWork(current, workInProgress, renderLanes) {
        ...
        switch (workInProgress.tag) {
            ...
            case 1:
                return ((lazyComponent = workInProgress.type),
                ...
                a: {
                    ...
                    if (supportsHydration && init.isDehydrated) {
                        if (((init = {
                            ...
                            for (supportsHydration &&
                                ((nextHydratableInstance =
                                    getFirstHydratableChildWithinContainer(workInProgress.stateNode.containerInfo)),
                                    (hydrationParentFiber = workInProgress),
                                    (isHydrating = !0),
                                    (hydrationErrors = null),
                                    (rootOrSingletonContext = !0)),
                    ...
                    return (markRef(current, workInProgress),
                        null === current
                            ? (renderLanes = getResource(workInProgress.type, null, workInProgress.pendingProps, null))
                                ...
                                : isHydrating ||
                                    (workInProgress.stateNode = createHoistableInstance(workInProgress.type, workInProgress.pendingProps, rootInstanceStackCursor.current, workInProgress))
                    ...
                    return (pushHostContext(workInProgress),
                        null === current &&
                            ...
                            ((lazyComponent = workInProgress.stateNode =
                                resolveSingletonInstance(workInProgress.type, workInProgress.pendingProps, rootInstanceStackCursor.current, contextStackCursor.current, !1)),
                                (hydrationParentFiber = workInProgress),
                                (rootOrSingletonContext = !0),
                                (nextHydratableInstance = getFirstHydratableChildWithinSingleton(workInProgress.type, lazyComponent, nextHydratableInstance))),
            ...
            case 5:
                if (null === current && isHydrating) {
                    ...
                    if ((init = lazyComponent = nextHydratableInstance)) {
                        (lazyComponent = canHydrateInstance(lazyComponent, workInProgress.type, workInProgress.pendingProps, rootOrSingletonContext)),
                            null !== lazyComponent
                ...
                null !== workInProgress.memoizedState &&
                    ((init = renderWithHooks(current, workInProgress, TransitionAwareHostComponent, null, null, renderLanes)),
                        isPrimaryRenderer
            ...
            case 12:
                return (reconcileChildren(current, workInProgress, workInProgress.pendingProps.children, renderLanes),
                    workInProgress.child);
            case 10:
                return ((lazyComponent = workInProgress.pendingProps),
                    pushProvider(workInProgress, workInProgress.type, lazyComponent.value),
                    reconcileChildren(current, workInProgress, lazyComponent.children, renderLanes),
                    workInProgress.child);
            case 9:
                return ((init = workInProgress.type._context),
    ...
    function appendAllChildren(parent, workInProgress, needsVisibilityToggle, isHidden) {
        if (supportsMutation) {
            for (needsVisibilityToggle = workInProgress.child; null !== needsVisibilityToggle;) {
                if (5 === needsVisibilityToggle.tag ||
                    6 === needsVisibilityToggle.tag) {
                    appendInitialChild(parent, needsVisibilityToggle.stateNode);
                }
                else if (!(4 === needsVisibilityToggle.tag ||
                ...
                for (; null === needsVisibilityToggle.sibling;) {
                    if (null === needsVisibilityToggle.return ||
            ...
            for (var node$93 = workInProgress.child; null !== node$93;) {
                if (5 === node$93.tag) {
                    ...
                    needsVisibilityToggle &&
                        isHidden &&
                        (instance = cloneHiddenInstance(instance, node$93.type, node$93.memoizedProps));
                    ...
                    (instance = node$93.stateNode),
                        needsVisibilityToggle &&
                            isHidden &&
                            (instance = cloneHiddenTextInstance(instance, node$93.memoizedProps)),
                        appendInitialChild(parent, instance);
                }
        ...
        if (supportsPersistence) {
            for (var node = workInProgress.child; null !== node;) {
                if (5 === node.tag) {
                    ...
                    needsVisibilityToggle &&
                        isHidden &&
                        (instance = cloneHiddenInstance(instance, node.type, node.memoizedProps));
                    ...
                    (instance = node.stateNode),
                        needsVisibilityToggle &&
                            isHidden &&
                            (instance = cloneHiddenTextInstance(instance, node.memoizedProps)),
                        appendChildToContainerChildSet(containerChildSet, instance);
                }
                else if (4 !== node.tag) {
    ...
    function updateHostComponent(current, workInProgress, type, newProps) {
        if (supportsMutation) {
            ...
            if ((current = doesRequireClone(current, workInProgress)) ||
                ...
                oldProps$96 === currentInstance
                    ...
                    : (finalizeInitialChildren(oldProps$96, type, newProps, currentHostContext) && markUpdate(workInProgress),
        ...
        switch (workInProgress.tag) {
                    ...
                    null === current
                        ? (markUpdate(workInProgress),
                            null !== nextResource
                                ...
                                : (bubbleProperties(workInProgress),
                                    preloadInstanceAndSuspendIfNeeded(workInProgress, renderLanes, newProps)))
                        : nextResource
                ...
                if (supportsSingletons) {
                    ...
                    if (null !== current && null != workInProgress.stateNode) {
                        ...
                        popHydrationState(workInProgress)
                            ...
                            : ((current = resolveSingletonInstance(nextResource, newProps, renderLanes, current, !0)),
            ...
            case 5:
                ...
                if (null !== current && null != workInProgress.stateNode) {
                    ...
                    popHydrationState(workInProgress)
                        ? prepareToHydrateHostInstance(workInProgress, current)
                        : ((nextResource = createInstance(renderLanes, newProps, rootInstanceStackCursor.current, current, workInProgress)),
                            appendAllChildren(nextResource, workInProgress, !1, !1),
                            (workInProgress.stateNode = nextResource),
                            finalizeInitialChildren(nextResource, renderLanes, newProps, current) && markUpdate(workInProgress));
                }
                bubbleProperties(workInProgress);
            ...
            case 4:
                return (popHostContainer(),
                    ...
                    null);
            case 10:
                return (popProvider(workInProgress.type),
                    bubbleProperties(workInProgress),
                    null);
            case 19:
                pop(suspenseStackCursor);
                ...
                if (null === cache$113) {
                    if (newProps)
                        ...
                        if (0 !== workInProgressRootExitStatus ||
                ...
                if (null !== nextResource.tail) {
                    return ((workInProgress = nextResource.tail),
            ...
            case 4:
                supportsMutation
                    ? ((prevHostParent = hostParent),
                        ...
                        (hostParentIsContainer = prevHostParentIsContainer))
                    : (supportsPersistence &&
                        commitHostPortalContainerChildren(deletedFiber.stateNode, deletedFiber, createContainerChildSet()),
                        recursivelyTraverseDeletionEffects(finishedRoot, nearestMountedAncestor, deletedFiber));
                break;
            case 0:
            case 11:
    ...
    function commitMutationEffectsOnFiber(finishedWork, root) {
        ...
        switch (finishedWork.tag) {
            ...
            case 4:
                ...
                flags & 4 &&
                    supportsPersistence &&
                    commitHostPortalContainerChildren(finishedWork.stateNode, finishedWork, finishedWork.stateNode.pendingChildren);
                break;
            case 12:
                recursivelyTraverseMutationEffects(root, finishedWork);
                commitReconciliationEffects(finishedWork);
                ...
                if (flags & 2048) {
                    ...
                    try {
                        ...
                        "function" === typeof onPostCommit &&
                            onPostCommit(id, null === finishedWork.alternate ? "mount" : "update", finishedRoot.passiveEffectDuration, -0);
                    }
                    catch (error) {
                        captureCommitPhaseError(finishedWork, finishedWork.return, error);
                    }
        ...
        switch (selector.$$typeof) {
            ...
            case TEXT_TYPE:
                if (5 === tag || 6 === tag || 26 === tag || 27 === tag) {
                    if (((fiber$jscomp$0 = getTextContent(fiber$jscomp$0)),
                        null !== fiber$jscomp$0 &&
            ...
            case TEST_NAME_TYPE:
                if (5 === tag || 26 === tag || 27 === tag) {
                    if (((fiber$jscomp$0 = fiber$jscomp$0.memoizedProps["data-testname"]),
    ...
    function performWorkOnRoot(root$jscomp$0, lanes, forceSync) {
        ...
        var shouldTimeSlice = (!forceSync &&
            ...
            checkIfRootIsPrerendering(root$jscomp$0, lanes), exitStatus = shouldTimeSlice
            ? renderRootConcurrent(root$jscomp$0, lanes)
            : renderRootSync(root$jscomp$0, lanes, !0), renderWasConcurrent = shouldTimeSlice;
        do {
            if (0 === exitStatus) {
    ...
    function createFiberFromTypeAndProps(type, key, pendingProps, owner, mode, lanes) {
        ...
        if ("function" === typeof type)
            ...
            a: switch (type) {
                case REACT_ACTIVITY_TYPE:
                    return ((type = createFiber(31, pendingProps, key, mode)),
                ...
                case REACT_STRICT_MODE_TYPE:
                    ...
                    break;
                case REACT_PROFILER_TYPE:
                    return ((type = createFiber(12, pendingProps, key, mode | 2)),
                        (type.elementType = REACT_PROFILER_TYPE),
                        (type.lanes = lanes),
                        type);
                case REACT_SUSPENSE_TYPE:
                    return ((type = createFiber(13, pendingProps, key, mode)),
                        (type.elementType = REACT_SUSPENSE_TYPE),
                        (type.lanes = lanes),
                        type);
                case REACT_SUSPENSE_LIST_TYPE:
                    return ((type = createFiber(19, pendingProps, key, mode)),
    ...
    (_a = React.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE) !== null && _a !== void 0 ? _a : {
        H: null,
        A: null,
        T: null,
        S: null,
    ...
    exports.discreteUpdates = function (fn, a, b, c, d) {
        var prevTransition = ReactSharedInternals.T, previousPriority = getCurrentUpdatePriority();
        try {
            return (setCurrentUpdatePriority(2),
                (ReactSharedInternals.T = null),
                fn(a, b, c, d));
        }
        finally {
    ...
    exports.getFindAllNodesFailureDescription = function (hostRoot, selectors) {
        ...
        for (var index = 0; index < hostRoot.length;) {
            ...
            if ((5 !== tag && 26 !== tag && 27 !== tag) || !isHiddenSubtree(fiber)) {
                if ((matchSelector(fiber, selector) &&
...
//# sourceMappingURL=react-reconciler.production.cjs.map